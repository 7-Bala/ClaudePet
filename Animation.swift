...
/// Claude Code's animation table, reproduced frame for frame, plus Chef attire
/// cooking animations inspired by the Claude Code Reels.
enum Sequences {
    ...
    /// Full chef cooking sequence: flip pan, sizzle food, show off dish
